...
<Update label="October 17, 2025" description="2.7.0">
  ...
  <Frame>
    <img src="./images/17-10-2025/secret-keys.png" />
  </Frame>
  ...
  - **[Pica MCP Server 2.0.0](https://mcp.picaos.com)**: Major version upgrade featuring vector search for actions, drastically optimized context usage for faster and more efficient performance, and a new [hosted remote MCP server](https://mcp.picaos.com) option.
    <img src="./images/17-10-2025/remote-mcp.png" style={{ borderRadius: '10px' }} />
