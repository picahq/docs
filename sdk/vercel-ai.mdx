...
| connectors | `String[]` | No | All available connectors | List of connector keys to give the LLM access to. If not provided, all available connectors will be initialized. |
