---
title: "LangChain"
description: "Build AI agents with LangChain and Pica ToolKit"
---

<div align="left" style={{ display: 'flex' }}>
  <a href="https://pypi.org/project/pica-langchain">
    <img src="https://img.shields.io/pypi/v/pica-langchain" alt="pypi version" />
  </a>
</div>

<Frame>
  <img src="/images/toolkit/langchain-banner.svg" alt="Pica LangChain Banner" style={{ borderRadius: '5px' }} />
</Frame>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="github"
    href="https://github.com/picahq/pica-langchain"
  >
  ...
  <Card
    title="PyPI Package"
    icon="python"
    href="https://pypi.org/project/pica-langchain"
  >
  ...
  >
    Explore 150+ available integrations and actions
  </Card>
  <Card
    title="Get Help"
    icon="envelope"
