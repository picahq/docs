---
title: "Vercel AI SDK"
description: "Build AI agents with Vercel AI SDK and Pica ToolKit"
---
...
<Frame>
  <img src="/images/toolkit/vercel-ai-sdk-banner.svg" alt="Pica Vercel AI SDK Banner" style={{ borderRadius: '5px' }} />
</Frame>
...
```typescript expandable app/api/chat/route.ts
import { Pica } from '@picahq/toolkit';
import { openai } from '@ai-sdk/openai';
import { streamText } from 'ai';
