---
title: "Management"
description: "Manage user connections, configure integrations, and make authenticated API requests"
---

<Frame>
  <img src="/images/authkit/authkit.png" alt="AuthKit management page" />
</Frame>

<Card
  title="Open AuthKit Management"
...
<Card
  title="Learn more about the Passthrough API"
  icon="arrow-up-right-from-square"
...
```typescript expandable Example using the Vercel AI SDK
...
<Frame caption="Configure integrations visibility in the Pica dashboard">
  <img src="/images/authkit/toggle.png" alt="AuthKit dashboard configuration" />
</Frame>
...
<Frame caption="Configure OAuth credentials">
  <img src="/images/authkit/oauth-credentials.png" alt="AuthKit dashboard configuration" />
</Frame>
...
<Frame caption="Configure OAuth scopes and permissions">
  <img src="/images/authkit/oauth-scopes.png" alt="AuthKit dashboard configuration" />
</Frame>
...
Contact our support team at support@picaos.com for assistance
</Card>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="code"
    href="/api-reference/passthrough"
  >
  ...
  <Card
    title="Vault API"
    icon="vault"
    href="/api-reference/vault/connections/list"
  >
