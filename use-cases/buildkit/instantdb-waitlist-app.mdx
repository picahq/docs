---
title: "Build a Waitlist App with InstantDB"
description: "Build a waitlist app using InstantDB with real-time signups, automatic welcome emails, and admin dashboard in minutes."
---

<img
  src="/images/tutorials/instantdb-waitlist-app.png"
  alt="InstantDB Waitlist App"
...
<img
  src="/images/tutorials/instantdb-waitlist-app-admin.png"
  alt="InstantDB Waitlist App Admin"
  style={{ borderRadius: '5px' }}
/>
</Step>
</Steps>
...
<Card
  title="Source Code"
  icon="github"
  href="https://github.com/picahq/awesome-pica/tree/main/instantdb-waitlist-app"
>
