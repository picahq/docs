---
title: Build a Gmail and Calendar Dashboard
description: 👋 Follow this tutorial to build a beautiful Gmail & Calendar dashboard that fetches your emails and events using Pica MCP — all in under 10 minutes.
---

<img
  src="/images/tutorials/gmail-calendar-dashboard.png"
  alt="Gmail & Calendar Dashboard"
