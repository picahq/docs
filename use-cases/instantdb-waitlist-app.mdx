...
<img
  src="../images/pica-thumbnail.png"
  alt="ElevenLabs"
  style={{ borderRadius: '5px' }}
/>

🚀 Building Apps with InstantDB is Easier Than Ever

👋 Follow this tutorial to build a waiting list app with real-time signups and automatic welcome emails using Pica + InstantDB + Next.js.
...
<Info>
💡 Full demo app (including an admin panel with live stats & signup table) will be available here: `Comming Soon`
</Info>
