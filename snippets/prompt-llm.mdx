...
<Tabs>
  <Tab title="Vercel AI SDK" icon="/images/vercel.svg">
    <Card>
      ...
      <CodeBlock title="text" filename="Vercel AI SDK Tool" wrap>
        {prompt}
      </CodeBlock>
    </Card>
  </Tab>
  <Tab title="LangChain" icon="/images/langchain-icon.svg">
    <Card>
      ...
      <CodeBlock title="text" filename="LangChain Tool" wrap>
        {prompt}
      </CodeBlock>
    </Card>
  </Tab>
  <Tab title="MCP Server" icon="/images/model-context-protocol.svg">
    <Card>
      ...
      <CodeBlock title="text" filename="MCP Server Tool" wrap>
        {prompt}
      </CodeBlock>
    </Card>
  </Tab>
